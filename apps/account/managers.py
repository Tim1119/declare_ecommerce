...
class UserAccountManager(BaseUserManager):
    ...
    def create_user(self, full_name, email, password, **extra_fields):
        if not full_name:
            raise ValueError(_('Users must have a fullname comprising their first and last names'))
    ...
    def create_superuser(self, full_name, email, password, **extra_fields):
        ''' set is_staff,is_super_user and is_active permissions to True by default for admin'''
